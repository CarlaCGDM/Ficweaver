...
type ViewMode = "both" | "none" | "left" | "right";
...
export default function CanvasOverlay({
  ...
  const [viewMode, setViewMode] = useState<ViewMode>("both"); // default: both panels visible
  ...
  return (
    ...
    >
      {/* 🆕 View Toggle + Undo/Redo (Top Right) */}
      <div
        style={{
          position: "absolute",
          top: "10px",
      ...
      >
        ...
        <div style={{ display: "flex", gap: "4px" }}>
          <ToggleButton
            icon={<VscLayoutCentered size={18} />}
          ...
          <ToggleButton
            icon={<VscLayoutActivitybarLeft size={18} />}
            active={viewMode === "left"}
            title="Show only left panel"
            onClick={() => setViewMode("left")}
          />
          <ToggleButton
            icon={<VscLayoutActivitybarRight size={18} />}
            active={viewMode === "right"}
            title="Show only right panel"
            onClick={() => setViewMode("right")}
          />
          <ToggleButton
            icon={<VscLayoutStatusbar size={18} />}
            active={viewMode === "none"}
            title="Hide both panels (maximize canvas)"
      ...
      >
        ...
        {showGuide && (
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              <VscLayoutCentered size={14} color={"#766DA7"} /> <span style={guideKeywordStyle}>Layout</span> - 1, 2, 3, 4
            </div>
          </div>
        )}
      </div>
